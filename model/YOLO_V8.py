...
def yolov8_N(num_classes: int = 80):
    depth = [1, 2, 2]
    width = [3, 16, 32, 64, 128, 256]
    return YOLO_V8(width, depth, num_classes)


def yolov8_S(num_classes: int = 80):
    depth = [1, 2, 2]
    width = [3, 32, 64, 128, 256, 512]
    return YOLO_V8(width, depth, num_classes)


def yolov8_M(num_classes: int = 80):
    depth = [2, 4, 4]
    width = [3, 48, 96, 192, 384, 576]
    return YOLO_V8(width, depth, num_classes)


def yolov8_L(num_classes: int = 80):
    depth = [3, 6, 6]
    width = [3, 64, 128, 256, 512, 512]
    return YOLO_V8(width, depth, num_classes)


def yolov8_XL(num_classes: int = 80):
    depth = [3, 6, 6]
